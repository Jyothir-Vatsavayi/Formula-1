...
# MAGIC %md
# MAGIC #### Step 3 - Select only columns required and renaming them
...
races_final_df = races_selected_df.write.mode("overwrite").format("delta").saveAsTable("f1_processed.races")
